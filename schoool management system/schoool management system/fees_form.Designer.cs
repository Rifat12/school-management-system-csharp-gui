...
namespace schoool_management_system
{
    partial class fees_form
    {
        ...
        private void InitializeComponent()
        {
			...
			this.label2.Text = "Your fees:";
			// 
			// dataGridView1
			// 
			this.dataGridView1.ColumnHeadersHeightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.AutoSize;
			this.dataGridView1.Location = new System.Drawing.Point(436, 166);
			...
			this.button1.Text = "Get Fees";
			this.button1.UseVisualStyleBackColor = true;
			this.button1.Click += new System.EventHandler(this.button1_Click);
			// 
			// textBox1
			// 
			this.textBox1.Location = new System.Drawing.Point(200, 128);
			...
			this.label3.Text = "Enter your Student ID to get  your outstanding fees ";
			// 
			// label1
			// 
