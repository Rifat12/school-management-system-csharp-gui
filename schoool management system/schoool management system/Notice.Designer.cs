namespace schoool_management_system
{
	partial class Notice
	{
		...
		private void InitializeComponent()
		{
			...
			this.label2.Text = "2.COURSE ROUTINE FOR SPRING 2020-2021";
			// 
			// label3
			// 
			...
			this.label3.Text = "1.DEADLINE OF GRADE SUBMISSION \r\nAND ACCOUNT\'S DUES";
			// 
			// label4
			// 
			...
			this.label4.Size = new System.Drawing.Size(410, 60);
			this.label4.TabIndex = 20;
			this.label4.Text = "3.MEMORANDUM MAKEUP CLASS \r\nTIME DEC 2020";
			// 
			// label5
			// 
			...
			this.label5.Size = new System.Drawing.Size(441, 60);
			this.label5.TabIndex = 21;
			this.label5.Text = "4.EM_MS_Online_Class Routine HSC \r\nPreparatory and Teachers-List";
			// 
			// Notice
			// 
